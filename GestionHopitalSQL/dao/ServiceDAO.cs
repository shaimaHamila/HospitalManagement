    ...
    public class ServiceDAO
    {
           ...
           List<Medecin> medecins = bdMed.FindAll();
            ...
            try
            {
               cnx=ConnexionHopital.GetInstance();
                ...
                MySqlCommand cmd = new MySqlCommand("select * from Service", cnx);
        ...
        {   //pour trouver le Medecin selon cin du chefService
            ...
            try {
                ...
                cnx = ConnexionHopital.GetInstance();
                MySqlCommand cmd = new MySqlCommand("select * from Service where nom=@nom", cnx);
        ...
        public void Remove(Service s)
        {
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("delete from Service where nom=@nom", cnx);
        ...
        public void Add(Service s)
        {
            ...
            {
                cnx = ConnexionHopital.GetInstance();//ouvrir la connexion
                MySqlCommand cmd = new MySqlCommand("insert into Service values(@nom, @lit, @cin)", cnx);
                cmd.Parameters.Add("@nom", s.Nom);//
        ...
        public void Update(Service s)
        {
            ...
            {
                cnx = ConnexionHopital.GetInstance();//ouvrir la connexion
                MySqlCommand cmd = new MySqlCommand("update service set  nom=@nom, nblits=@nb, chefser=@chef where nom=@nom", cnx);
