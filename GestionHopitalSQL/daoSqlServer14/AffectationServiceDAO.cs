    ...
    public class AffectationServiceDAO
    {
        ...
        public List<AffectationService> FindAll()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from affectation_service", cnx);
        ...
        public void Remove(AffectationService aff)
        {
            ...
            {
                cnx = ConnexionHopital.GetInstance();
                SqlCommand cmd = new SqlCommand("delete from affectation_service where cinMed=@cin and debut=@debut", cnx);
        ...
        public void Add(AffectationService affectation)
        {
            ...
            {
                cnx = ConnexionHopital.GetInstance();
                SqlCommand cmd = new SqlCommand("insert into affectation_service values(@cin,@service, @debut, @fin)", cnx);
        ...
        public List<AffectationService> FindToService(String service)
        {
            ...
            {
                cnx = ConnexionHopital.GetInstance();
                SqlCommand cmd = new SqlCommand("select * from affectation_service where nomServ=@nomServ", cnx);
        ...
        {   //pour trouver le Medecin selon cin
            ...
            {
                cnx = ConnexionHopital.GetInstance();
                SqlCommand cmd = new SqlCommand("select * from affectation_service where cinMed=@cin", cnx);
                cmd.Parameters.Add("@cin", cin);//
                SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
        ...
        public void Update(AffectationService m)
        {
            ...
            {
                cnx = ConnexionHopital.GetInstance();
                SqlCommand cmd = new SqlCommand("update affectation_service set  cinMed=@cin, nomServ=@prenom, debut=#debut, fin=@fin where cinMed=@cin and debut=@debut", cnx);
