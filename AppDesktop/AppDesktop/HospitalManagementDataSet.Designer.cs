...
namespace AppDesktop {
    ...
    public partial class HospitalManagementDataSet : global::System.Data.DataSet {
        ...
        public partial class DoctorsDataTable : global::System.Data.TypedTableBase<DoctorsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DoctorsRow AddDoctorsRow(string FirstName, string LastName, System.DateTime Birthday, string Address) {
            ...
            public System.DateTime Birthday {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Birthday\' in table \'Doctors\' is DBNull.", e);
                    }
                }
                set {
...
namespace AppDesktop.HospitalManagementDataSetTableAdapters {
    ...
    public partial class DoctorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Doctors] WHERE (([Id] = @Original_Id) AND ((@IsNull_Birthday =" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Doctors] ([FirstName], [LastName], [Birthday], [Address]) VALU" +
                "ES (@FirstName, @LastName, @Birthday, @Address);\r\nSELECT Id, FirstName, LastName" +
                ", Birthday, Address FROM Doctors WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Doctors] SET [FirstName] = @FirstName, [LastName] = @LastName, [Birthday] = @Birthday, [Address] = @Address WHERE (([Id] = @Original_Id) AND ((@IsNull_Birthday = 1 AND [Birthday] IS NULL) OR ([Birthday] = @Original_Birthday)));
SELECT Id, FirstName, LastName, Birthday, Address FROM Doctors WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AppDesktop.Properties.Settings.Default.HospitalManagementConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Birthday, Address FROM dbo.Doctors";
        ...
        public virtual int Fill(HospitalManagementDataSet.DoctorsDataTable dataTable) {
        ...
        public virtual HospitalManagementDataSet.DoctorsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HospitalManagementDataSet.DoctorsDataTable dataTable = new HospitalManagementDataSet.DoctorsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HospitalManagementDataSet.DoctorsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, global::System.Nullable<global::System.DateTime> Original_Birthday) {
        ...
        public virtual int Insert(string FirstName, string LastName, global::System.Nullable<global::System.DateTime> Birthday, string Address) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, global::System.Nullable<global::System.DateTime> Birthday, string Address, int Original_Id, global::System.Nullable<global::System.DateTime> Original_Birthday, int Id) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, global::System.Nullable<global::System.DateTime> Birthday, string Address, int Original_Id, global::System.Nullable<global::System.DateTime> Original_Birthday) {
            return this.Update(FirstName, LastName, Birthday, Address, Original_Id, Original_Birthday, Original_Id);
        }
    }
